...
// the same as mockHardware but with another buffer at index 0
export const mockHardwareWithBuffer: Hardware[] = [
    {
        id: 0,
        name: "Buffer",
        model_number: "Zero",
        manufacturer: "useless",
        datasheet: "https://example.com/datasheet",
        quantity_available: 10,
        max_per_team: 2,
        picture: "https://i.imgur.com/iUpI1hC.jpg",
        categories: [1],
        quantity_remaining: 5,
        notes: "useless buffer to make it indexed from 1",
    },
    {
        id: 1,
        name: "Arduino",
